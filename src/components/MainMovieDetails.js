...
const MainMovieDetails = ({ title, details }) => {
  return (
    <div className=" sm:h-screen lg:aspect-video flex flex-col justify-start gap-2 sm:pt-44 md:pt-44 lg:pt-66 lg:px-11 sm:px-6 absolute  text-white bg-gradient-to-r from-black  ">
